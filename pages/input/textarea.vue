...
import { COLOR_CLASS_MAP, SIZE_CLASS_MAP } from "~/components/ui/textarea/textarea.vue";
...
<template>
  <div>
    ...
    <component-preview>
      ...
      <ui-textarea v-model="value" placeholder="Bio" class="w-full" />
    </component-preview>
    ...
    <component-preview>
      ...
      <ui-textarea placeholder="You can't touch this" class="w-full" disabled />
    </component-preview>
  </div>
</template>
