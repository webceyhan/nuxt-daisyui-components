...
import { DESCRIPTIONS, COLORS, SIZES } from "~/data/text-input";
...
<template>
  <div>
    ...
    <component-preview>
      ...
      <ui-text-input v-model="value" placeholder="Type here" class="w-full" />
    </component-preview>
    ...
    <component-preview>
      ...
      <ui-text-input placeholder="You can't touch this" class="w-full" disabled />
    </component-preview>
  </div>
</template>
